...
Gate 6C1 implements the neural-forecasting protocol already frozen on `main` and tracked by Issue #13.
...
2. Gate 6C2 executes governed training-and-validation-only evidence after Gate 6C1 is merged, green, and formally closed.
...
PR #12 and Issue #11 are superseded and closed. Their residual MLP, causal TCN, GRU, six-configuration, and five-seed design is not part of the approved Gate 6C framework and must not be revived without formal change control.
